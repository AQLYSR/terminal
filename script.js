...
jQuery(function($, undefined) {
    ...
    $('#terminal').terminal(function(command, term) {
        ...
        if (command === 'help') {
            ...
            term.echo('[[b;white;]Here are some of my key projects:]');
            term.echo('');
            ...
            term.echo('[[b;white;]My Technical Skills:]');
            term.echo('');
            ...
            term.echo('[[b;white;]You can reach me via:]');
            term.echo('');
            ...
            term.echo('[[b;white;]My Social Media Links:]');
            term.echo('');
            ...
            term.echo('Command not found: ' + command + '. Type [[b;lime;]help] for a list of commands.');
        }
    }, {
        // Terminal options
        greetings: '[[b;white;]Welcome to My Terminal Portfolio!]\n\nType [[b;lime;]help] to get started.',
